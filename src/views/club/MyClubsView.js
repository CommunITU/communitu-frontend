...
const headCells = [
    {id: 'name', numeric: false, disablePadding: true, label: 'Club Name '},
    {id: 'createdDate', numeric: true, disablePadding: false, label: 'Created Date'},
    {id: 'participant_num', numeric: true, disablePadding: false, label: 'Participant Number'},
    {id: 'event_num', numeric: true, disablePadding: false, label: 'Total organized events'},
...
export function MyClubsView(props) {
...
export default withRouter(connect(mapStatetoProps, null)(MyClubsView));
